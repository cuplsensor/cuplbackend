...
class BoxService(Service):
    ...
    def simulate(self, id, frontendurl, nsamples):
        """ Get URL that would be generated by a box. """
        box = self.get(id=id)
        smplintervalmins = 10
        smplinterval = datetime.timedelta(minutes=smplintervalmins)

        # Initialise encoder
        InstrumentedSampleTRH(baseurl=frontendurl,
                              serial=box.serial,
